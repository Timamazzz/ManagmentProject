...
from users_app.fieldsets import default_fieldsets, create_fieldsets
from users_app.forms import ReportForm
from users_app.models import User, Volunteer, Remark, VolunteerItem, Item, Report
...
class VolunteerAdmin(admin.ModelAdmin):
    ...
    def get_inline_instances(self, request, obj=None):
        ...
        if obj and obj.status == 'dismissed':
            return []
